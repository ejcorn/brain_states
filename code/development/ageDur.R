...
nbackDur <- readMat(paste(masterdir,'analyses/nbackblocks/nBackRestExcludeDwellTime_k',
                          numClusters,name_root,'.mat',sep = ''))$BlockDwellTime*100
nbackDur <- readMat(paste(masterdir,'analyses/transitionprobabilities/nBackCombStateDurations_k',
                        numClusters,name_root,'.mat',sep = ''))$stateDuration * 100
