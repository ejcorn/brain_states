...
#python code/assesscluster/brainvis_general.py $D $K $NPARC 'centroids/task_regress/CentroidsnBackTaskRegressed_k' 'centroids/task_regress/CentroidsnBackTaskRegressed_k'$K'.mat'
...
#python code/assesscluster/brainvis_general.py $D $K $NPARC 'centroids/ar_null/Centroids_ARNullModel_k' 'centroids/ar_null/Centroids_ARNullModel_k'$K'.mat'
python code/assesscluster/brainvis_general.py $D $K $NPARC 'centroids/ar_null_EJC/Centroids_ARNullModelEJC_k' 'centroids/ar_null_EJC/Centroids_ARNullModelEJC_k'$K'.mat'
